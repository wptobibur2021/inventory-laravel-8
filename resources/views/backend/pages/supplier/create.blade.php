                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    <h4 class="page-title float-left">Supplier</h4>

                                    <ol class="breadcrumb float-right">
                                        <li class="breadcrumb-item"><a href="/">Admin</a></li>
                                        <li class="breadcrumb-item"><a href="{{ route('index.supplier') }}">All Supplier</a></li>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card-box table-responsive">
                                    ...
                                    <form class="form-horizontal"  action="{{ route('store.supplier') }}"  method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-sm-4">
                                                <div class="form-group m-b-25">
                                                    <div class="col-xs-12">
                                                        ...
                                                        <input class="form-control" name="address" type="text" required="" id="village" placeholder="Enter Village">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6 col-sm-4">
                                                <div class="form-group m-b-25">
                                                    <div class="col-xs-12">
                                                        ...
                                                        <input class="form-control" name="shop_name" type="text" id="shop_name" required="" placeholder="Enter Post Office">
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group account-btn text-center m-t-10">
                                            <div class="col-xs-12">
                                                <button class="btn w-lg btn-rounded btn-lg btn-custom waves-effect waves-light" type="submit">Add supplier</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
