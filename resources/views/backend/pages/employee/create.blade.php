                                ...
                                <div class="card-box table-responsive">
                                    ...
                                    <form class="form-horizontal"  action="{{ route('store.employee') }}"  method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="col-md-6 col-sm-4">
                                                <div class="form-group m-b-25">
                                                    <div class="col-xs-12">
                                                        ...
                                                        <input class="form-control" name="village" type="text" required="" id="village" placeholder="Enter Village">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6 col-sm-4">
                                                <div class="form-group m-b-25">
                                                    <div class="col-xs-12">
                                                        ...
                                                        <input class="form-control" name="post_office" type="text" id="post_office" required="" placeholder="Enter Post Office">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6 col-sm-4">
                                                <div class="form-group m-b-25">
                                                    <div class="col-xs-12">
                                                        ...
                                                        <input class="form-control" name="upzila" type="text" required="" id="upzila" placeholder="Enter Upzila">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6 col-sm-4">
                                                <div class="form-group m-b-25">
                                                    <div class="col-xs-12">
                                                        ...
                                                        <input class="form-control" name="zila" type="text" required="" id="zila" placeholder="Enter Zila">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6 col-sm-4">
                                                <div class="form-group m-b-25">
                                                    <div class="col-xs-12">
                                                        ...
                                                        <input class="form-control" name="joining_date" type="date" required="" id="joining_date" placeholder="Joining Date">
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group account-btn text-center m-t-10">
                                            <div class="col-xs-12">
                                                <button class="btn w-lg btn-rounded btn-lg btn-custom waves-effect waves-light" type="submit">Add Employee</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
