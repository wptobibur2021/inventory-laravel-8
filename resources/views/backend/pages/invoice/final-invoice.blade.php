                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="clearfix p-t-50">
                                                <h3 class="text-muted">Payment Sumary:</h3>
                                                <small>
                                                    <h4 class="m-b-10"><small><strong>Total Amount : {{ $price_sum  }}</strong></small> </h4>
                                                    @if($print->advance)
                                                        <h4 class="m-b-10"><small><strong>Advance Payment : {{ $print->advance }}</strong></small> </h4>
                                                        <h4 class="m-b-10"><small><strong>Due Payment: {{ $price_sum-$print->advance }}</strong></small></h4>
                                                    @endif
                                                </small>
                                            </div>
                                        </div>
